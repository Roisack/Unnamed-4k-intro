...
"int size_x = 1024;"
"int size_y = 1024;"
"float magicNumber1 = 1.0;"
"float magicNumber2 = 1.0;"
"int octaveSetter = 9;"
...
"        perlinNoise += (noiseOctaves[i] * amplitude * abs(sin(texCoord.s*time/100)) - abs(cos(texCoord.t*time/20)));"
"    }"
"    } else {"
"    for (int i = octaveSetter-1; i >= 0; i--)"
"    {"
...
"    }"
"    col = perlinNoise;"
"    col.r = sin(perlinNoise*texCoord.s)/texCoord.t;"
"    col.g = cos(perlinNoise*texCoord.t)*texCoord.t;"
"    col.b = sin(texCoord.s * texCoord.s);"
"    gl_FragColor = col;"
"}";
